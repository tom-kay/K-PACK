...
{
    public partial class frmMessageBoxSample : Form
    {
        public frmMessageBoxSample()
        {
            InitializeComponent();
        }
        ...
        private void btnMsgText_Click(object sender, EventArgs e)
        {
            ...
            //-| For Example:
            DialogResult result = KMessageBox.Show("This is an example of a Text-Only Message Box.");
            ...
            //-| For Example:
            //KMessageBox.Show("This is an example of a Text-Only Message Box.");
        }
        ...
        private void btnMsgTextCaption1_Click(object sender, EventArgs e)
        {
            ...
            DialogResult result = KMessageBox.Show("This is an example of a Text + Caption Message Box.",
                "Important Message");
        ...
        {
            labelDialogResult.Text = "Dialog Box Result";
            var result = KMessageBox.Show("This is an example of an OK Button Message Box.",
                "OK Button",
        ...
        {
            labelDialogResult.Text = "Dialog Box Result";
            var result = KMessageBox.Show("This is an example of an OK, Cancel Button Message Box.",
                "OK-Cancel Button",
        ...
        {
            labelDialogResult.Text = "Dialog Box Result";
            var result = KMessageBox.Show("This is an example of an Abort, Retry, Ignore Button Message Box.",
        ...
        {
            labelDialogResult.Text = "Dialog Box Result";
            var result = KMessageBox.Show("This is an example of an Yes, No Button Message Box.",
                "Yes-No Button",
        ...
        {
            labelDialogResult.Text = "Dialog Box Result";
            var result = KMessageBox.Show("This is an example of an Yes, No, Cancel Button Message Box.",
        ...
        {
            labelDialogResult.Text = "Dialog Box Result";
            var result = KMessageBox.Show("This is an example of an Retry, Cancel Button Message Box.",
               "Retry-Cancel Button",
        ...
        {
            labelDialogResult.Text = "Dialog Box Result";
            var result = KMessageBox.Show("This is an example of an Question Icon Message Box.",
              "Question Icon",
              MessageBoxButtons.OKCancel,
        ...
        {
            labelDialogResult.Text = "Dialog Box Result";
            var result = KMessageBox.Show("This is an example of an Warning-Exclamation Icon Message Box.",
        ...
        {
            labelDialogResult.Text = "Dialog Box Result";
            var result = KMessageBox.Show("This is an example of an Error-Stop Icon Message Box.",
                "Error-Stop Icon",
                MessageBoxButtons.RetryCancel,
        ...
        {
            labelDialogResult.Text = "Dialog Box Result";
            var result = KMessageBox.Show("This is an example of an Information Icon Message Box.",
                "Information Icon",
                MessageBoxButtons.OK,
        ...
        {
            labelDialogResult.Text = "Dialog Box Result";
            var result = KMessageBox.Show("This is an example of a Message Box that sets Button1 as the Default Selected Button.\nThat is, pressing the Enter Key selects the Button1.",
             "Warning-Exclamation Icon",
             MessageBoxButtons.YesNoCancel,
             MessageBoxIcon.Warning,
        ...
        {
            labelDialogResult.Text = "Dialog Box Result";
            var result = KMessageBox.Show("This is an example of a Message Box that sets Button2 as the Default Selected Button.\nThat is, pressing the Enter Key selects the Button2.",
             "Warning-Exclamation Icon",
             MessageBoxButtons.RetryCancel,
             MessageBoxIcon.Information,
        ...
        {
            labelDialogResult.Text = "Dialog Box Result";
            var result = KMessageBox.Show("This is an example of a Message Box that sets Button3 as the Default Selected Button.\nThat is, pressing the Enter Key selects the Button3.",
           "Warning-Exclamation Icon",
           MessageBoxButtons.AbortRetryIgnore,
           MessageBoxIcon.Error,
        ...
        private void Any()
        {
            ...
            KMessageBox.Show(this, "Text");
            KMessageBox.Show(this, "Text", "Caption");
            KMessageBox.Show(this, "Text", "Caption", MessageBoxButtons.OKCancel);
            //Etc
        }
    }
}
